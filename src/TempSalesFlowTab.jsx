...
const STATUS_CFG = {
  ...
  reissued: { bg:C.greenBg, tx:C.green, label:'e-DOKUMEN DIKELUARKAN ✓' },
};
...
function printFlowHTML(rowRaw, stage) {
  ...
  const noticeText = {
    ...
    invoice: 'Dokumen ini ialah INVOIS SEMENTARA yang dikeluarkan secara manual kerana sambungan sistem SQL Account sedang terganggu semasa jualan ini dibuat. Invois e-Invois (LHDN) rasmi akan dikeluarkan semula dan dihantar kepada anda sebaik sambungan pulih. Sila simpan dokumen ini sebagai rujukan sementara sahaja, bukan invois cukai rasmi.',
  }[stage];
  ...
  return (
    <div style={{ fontFamily:"'Segoe UI',system-ui,sans-serif" }}>
      ...
      <div style={{ background:C.amberBg, border:`1.5px solid #eab308`, color:C.amber,
        ...
        sementara sahaja — bukan dokumen rasmi SQL Account/e-Invois. Untuk invois sahaja tanpa
        peringkat lain, guna tab Invois Sementara.
      </div>
